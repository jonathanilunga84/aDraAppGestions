(function($){
	...
	/* methode pour modification des status(observation) d'un projet */
	$('.linkBtnModifStatusProjet').on('click', function(event) {
		event.preventDefault();
		let linkBtnModifStatusProjet = $(this).attr('href');
		//console.log(linkBtnModifStatusProjet);
		swal.fire({
			title: 'Modification',
	...
	/* /End methode pour modification des status(observation) d'un projet */
})(jQuery); 
